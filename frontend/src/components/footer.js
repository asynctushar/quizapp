...
export default function Footer() {
  const navigation = [
    ...
    { label: "Lớp SAT của Moji", to: "https://moji.education/sat.html" },
    { label: "Liên hệ", to: "https://facebook.com/MojiEducation" }, // Update the href as per your route
    {label: "Hotline:", to:''},
    {label: "0961188133", to:''},
    {label: "0375435373", to:''},
        ...
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              ...
              <a
                href="https://facebook.com/MojiEducation"
                >
